...
post1 = Posts.objects.create(user_profile=user1, description="Das Rezept für die Pancakes gibt es in meiner Bio :-)", image="img/posts/img1.jpg", description_headline="Breakfast for Champions,",hashtags="#foodie #lazy", liked_by= user1)
post2 = Posts.objects.create(user_profile=user2, description="Leute checkt die neue Kollektion von Prana Luna for Her ab! Die haben ein paar richtig nice Outfits für euch", image="img/posts/img2.jpg, img/posts/img3.jpg, img/posts/img4.jpg", description_headline="Photoshoot for the New Brand Prana Luna.",hashtags="#fashion #instalife #prana", liked_by= user1)
post3 = Posts.objects.create(user_profile=user3, description="mit unglaublichen 50gr Protein pro Portion, und dazu schmeckt es einfach fantastisch", image="img/posts/img5.jpg", description_headline="Hier haben wir ein High Protein Porridge,",hashtags="#goodlife #healthylifestyle #fruits", liked_by= user1)
post4 = Posts.objects.create(user_profile=user4, description="diesesmal bin ich in Budapest.. und was soll ich sagen es ist einfach schön hier zu der Jahreszeit!", image="img/posts/img6.jpg", description_headline="Mal wieder unterwegs,",hashtags="#travel #vloglifestyle #happy", liked_by= user1)
